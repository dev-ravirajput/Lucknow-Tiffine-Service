        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kitchens/</span>Update Kitchen</h4>
              ...
              <div class="row">
                <div class="col-xl-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="post" action="{{ route('admin.update.kitchen', $kitchen->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="mb-4">
                          ...
                          <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="avatar-option">
                              <input type="radio" name="avatar" id="{{ $av->slug }}" value="{{ $av->slug }}" class="d-none" {{ $kitchen->featured_img == $av->slug ? 'checked' : '' }}>
                          ...
                          <div class="col-xl-6">
                            ...
                            <select class="form-select" name="status">
                              ...
                              <option value="active" {{ $kitchen->status == 'active' ? 'selected' : '' }}>Active</option>
                              <option value="draft" {{ $kitchen->status == 'draft' ? 'selected' : '' }}>Draft</option>
                            </select>
                          </div>
                            </div>
                            ...
                            <select class="form-select" name="type">
                              <option selected>Choose...</option>
                              <option value="veg" {{ $kitchen->type == 'veg' ? 'selected' : '' }}>Veg</option>
                              <option value="nonveg" {{ $kitchen->type == 'nonveg' ? 'selected' : '' }}>Non-Veg</option>
                              <option value="both" {{ $kitchen->type == 'both' ? 'selected' : '' }}>Both</option>
                            </select>
                          </div>
                            </div>
                            ...
                            <select class="form-select" name="rating">
                              <option selected>Choose...</option>
                              <option value="1" {{ $kitchen->rating == '1' ? 'selected' : '' }}>1 Star</option>
                              <option value="2" {{ $kitchen->rating == '2' ? 'selected' : '' }}>2 Star</option>
                              <option value="3" {{ $kitchen->rating == '3' ? 'selected' : '' }}>3 Star</option>
                              <option value="4" {{ $kitchen->rating == '4' ? 'selected' : '' }}>4 Star</option>
                              <option value="5" {{ $kitchen->rating == '5' ? 'selected' : '' }}>5 Star</option>
                            </select>
                          </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div id="map"></div>
                        <input type="hidden" value="{{ $kitchen->coordinates }}" id="coordinates" name="coordinates">
                       </div>
                        </div>
